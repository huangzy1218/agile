...
package com.agile.common.feign.sentinel.ext;
 ...
 */
@Slf4j
public class AgileSentinelInvocationHandler implements InvocationHandler {
    ...
    AgileSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            AgileSentinelInvocationHandler other = (AgileSentinelInvocationHandler) obj;
